...
import { environmentEmployee } from '../../../environments/environment';
...
export class EmployeeService {
  ...
  get(path: string, params: URLSearchParams = new URLSearchParams(), type: string): Observable<any> {
    return this.http.get(`${environmentEmployee.api_url}${path}`, { headers: this.setHeaders(type), search: params })
  ...
  put(path: string, body: Object = {}, type: string): Observable<any> {
    return this.http.put(
      `${environmentEmployee.api_url}${path}`, body,
  ...
  delete(path): Observable<any> {
    return this.http.delete(
      `${environmentEmployee.api_url}${path}`,
